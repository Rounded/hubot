...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "rounded-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/rounded"
  #   chef.validation_client_name = "rounded-validator"
  #   chef.validation_key_path = ".chef/rounded-validator.pem"
  # end
end
